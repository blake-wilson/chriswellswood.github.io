				...
				_elm_lang$core$String$toLower,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Basics_ops['++'], name, '.html'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var Elm = {};
Elm['CounterReusableView'] = Elm['CounterReusableView'] || {};
if (typeof _user$project$CounterReusableView$main !== 'undefined') {
    _user$project$CounterReusableView$main(Elm['CounterReusableView'], 'CounterReusableView', undefined);
}
